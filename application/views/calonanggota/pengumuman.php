                            ...
                            <div class="table-responsive">
                                 <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                      ...
                                      <?php if ($this->Peserta_m->get_num_row(['id_penerimaan' => $row->id_penerimaan, 'id_calonanggota' => $calonanggota->id_calonanggota]) != 0) { ?>
                                          ...
                                          <tr>   
                                              ...
                                              <td><?=$this->Peserta_m->get_num_row(['id_penerimaan' => $row->id_penerimaan])?></td>  
                                               ...
                                               <center>
                                                ...
                                                <a href="<?=base_url('calonanggota/pengumuman/'.$row->id_penerimaan)?>"> 
